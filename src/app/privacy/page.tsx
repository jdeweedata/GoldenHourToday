export default function PrivacyPolicy() {
  return (
    <main className="container mx-auto px-4 py-8">
      ...
      <p>
        Welcome to Golden Hour Today. We are committed to protecting your personal information and your right to privacy. If you have any questions or concerns about this privacy notice, or our practices with regards to your personal information, please contact us.
      </p>
      ...
      <ul className="list-disc list-inside ml-4 mt-2">
        <li>Location Data (for providing sunrise/sunset times)</li>
      </ul>
      ...
      <p>
       ...
       <h2 className="text-2xl font-semibold mt-6 mb-2">4. Will Your Information Be Shared With Anyone?</h2>
      <p>
